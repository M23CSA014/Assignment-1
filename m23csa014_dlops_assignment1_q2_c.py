...
Original file is located at
    https://colab.research.google.com/drive/15taq_BilMZPPwcWU8UO7RfHyju2-zC85
"""
...
for img, label in train_dataset:  # Unpack the tuple returned by CustomDataset
    lab_img = transforms.RandomHorizontalFlip(1.0)(img)  # Convert to LAB colorspace
...
# Train the model
train_losses, val_losses = train(model, criterion, optimizer, train_dataloader, val_dataloader, num_epochs=2)
    ...
    with torch.no_grad():
        for i, (data, _) in enumerate(dataloader):
            ...
            for j in range(data.size(0)):
                ...
                plt.title("RGB horizontal flipped image")
                plt.axis('off')
                plt.show()
